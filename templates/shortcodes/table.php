		...
		<table>
			...
			<tr>
				...
				<td <?php if( $attr['value'] == 'yes' || $attr['value'] == 'no' ) echo 'class="'. $attr['value'] .'"'; ?>>
					...
					<?php
					if( $attr['value'] == 'yes' ):
						echo apply_filters( 'mmspecs_table_value_output', '<svg class="yes" width="32" height="32" viewBox="0 0 32 32">
						...
						elseif( $attr['value'] == 'no' ):
							echo apply_filters( 'mmspecs_table_value_output', '<svg class="no" width="25" height="32" viewBox="0 0 25 32">
						...
						echo apply_filters( 'mmspecs_table_value_output', nl2br( $attr['value'] ), $attr['value'] );
					endif; ?>
				</td>
			</tr>
			<?php endforeach; ?>
...
endforeach;
echo '</div><!-- .mmspecs-product-table -->';